...
function _checkJoinChannel() {
  _checkJoinChannel = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(_ref) {
...
function localizeDate(date, fallbackText) {
  ...
  return "<!date^".concat(timestamp, "^{date_short_pretty} at {time}^").concat(linkToTime, "|").concat(fallbackText, ">");
}
/**
...
function _localizeMessageShortcut() {
  _localizeMessageShortcut = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(_ref2) {
    var shortcut, ack, context, payload, timeMatches, messageTime, originalMessage, i, originalPoster, timezoneOffset, convertedMessage, inChannel, stack, code, message, error_details;
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            shortcut = _ref2.shortcut, ack = _ref2.ack, context = _ref2.context, payload = _ref2.payload;
            _context3.next = 3;
            return ack();
          ...
          case 3:
            ...
            messageTime = new Date(Number(shortcut.message.ts.split('.')[0]) * 1000); // escape the original message to prevent SPI / double mentions for subteams
            ...
            for (i = timeMatches.length - 1; i >= 0; --i) {
              if (!timeMatches[i].start.knownValues.hasOwnProperty('hour') || timeMatches[i].start.knownValues.hasOwnProperty('millisecond')) {
            ...
            return _context3.abrupt("return", app.client.chat.postEphemeral({
              token: process.env.SLACK_OAUTH_TOKEN,
          ...
          case 12:
            ...
            convertedMessage = localizeMessageTimes(originalMessage, timeMatches, timezoneOffset); //check if user is in the channel
          ...
          case 17:
            ...
            return app.client.chat.postMessage({
              ...
              channel: shortcut.channel.id,
              thread_ts: shortcut.message.ts,
              text: ":sparkles: Here's <@".concat(shortcut.message.user, ">'s post in your timezone:\n") + convertedMessage.replace(/^|\n/g, '\n>')
            });
          ...
          case 24:
            _context3.next = 26;
            return app.client.views.open((0, _blocks.messageModal)({
              token: context.botToken,
          ...
          case 28:
            ...
            return app.client.views.open((0, _blocks.messageModal)({
              ...
              trigger_id: payload.trigger_id,
              text: convertedMessage,
              helpText: "\n\nBy the way, you should ask <@".concat(shortcut.message.user, "> to trigger this on their own message: I'll reply in-thread and magically convert the times for everyone.")
            }));
          ...
          case 32:
            ...
            stack = _context3.t0.stack, code = _context3.t0.code, message = _context3.t0.message, error_details = (0, _objectWithoutProperties2["default"])(_context3.t0, ["stack", "code", "message"]);
            Honeybadger.notify({
              stack: stack,
              code: code,
              message: message
